export const langCodeDetect =
  ...
  trong <strong>xử lý ngôn ngữ tự nhiên - natural language processing</strong>
  để tìm ra được các câu có nội dung quan trọng nhất trong bài viết Viblo.
</p>

<p>
  Ứng dụng trong phần hiển thị nội dung tổng quát của các bài viết trên Viblo
...
export const spamDetect =
  ...
  trong <strong>phân loại văn bản</strong> (được ghi nhận tại bài báo khoa học
  của nhóm Machine Learning đăng tại hội nghị Tính toán tiến hóa và Trí tuệ nhân tạo
  Châu Á Thái Bình Dương) và một số thay đổi để phù hợp cho tập dữ liệu của Viblo.
</p>

<p>
  Ứng dụng trong việc hỗ trợ cho người dùng đánh tag của văn bản,
  cũng như hỗ trợ việc chuẩn hóa các tag trong các bài viết của Viblo.
...
<p>
  Ứng dụng trong việc hỗ trợ hỗ trợ cho người quản trị viên
  tìm kiếm các thẻ tags trùng nhau dễ dàng hơn, cải thiện hiệu năng
  của hệ thống Viblo và đóng góp một phần quan trọng trong khâu tiền xử lý
...
export const tagCompare =
  ...
  <strong>modification operations</strong> nhằm biến đổi văn bản thứ nhất thành văn bản thứ hai.
</p>

<p>
  Ứng dụng trong việc hỗ trợ quản trị viên kiểm tra nhanh độ tương đồng
